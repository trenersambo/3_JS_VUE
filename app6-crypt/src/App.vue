<template>
  ...
  <div class=" w-100 h-100 opacity-80 bg-purple-800 inset-0 z-50 flex items-center justify-center">
...
<!-- тестирую связь  с API сайта https://www.livecoinwatch.com/ :: start-->
<button
        @click="testAPI()"
        type="button"
        class="my-4 inline-flex items-center py-2 px-4 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-full text-white bg-gray-600 hover:bg-gray-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
      >
        ...
        Протестировать API 
      </button><!-- тестирую связь  с API сайта https://www.livecoinwatch.com/ :: end-->
...
const ff = await fetch(new Request("https://api.livecoinwatch.com/coins/single"), {
  method: "POST",
  headers: new Headers({
    "content-type": "application/json",
    "x-api-key": "5b08db05-a4eb-4309-b983-99f16ce33b47",
  }),
  body: JSON.stringify({
    currency: "RUB",
    code: "BNB",
